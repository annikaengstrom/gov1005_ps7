...
error <- combo %>%
  mutate(error = abs(rep_adv - actual)) %>%
...
```{r}
labels <- c("Polled Republican Advantage", "Actual Republican Advantage","Trump Voters", "Clinton Voters", "Other Voters, 2016 Presidential Election", "Obama Voters", "Romney Voters",  "Other Voters, 2012 Presidential Election", "White Voters", "Black Voters", "Hispanic Voters", "Nonwhite Voters", "Foreign Born Voters",  "Female Voters", "Young Voters (29 and under)", "Older Voters (65 and older)")
              
variables <- c("rep_adv", "actual", "trump_pct", "clinton_pct", "otherpres16_pct", "obama_pct", "romney_pct", "otherpres12_pct", "white_pct", "black_pct", "hispanic_pct", "nonwhite_pct", "foreignborn_pct", "female_pct", "age29andunder_pct", "age65andolder_pct")
